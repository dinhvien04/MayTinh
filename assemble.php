<?php
  ...
  // Khởi tạo session để lưu trử thông tin người dùng
...
// bộ vi xữ lý (proccessor)
  if($result1 = mysqli_query($link,$sql1)) {
  }
  else{
      echo "not".mysqli_error($link);
  }
// bo mạnh chủ (motherboard)
  if($result2 = mysqli_query($link,$sql2)) {
  }
  else{
      echo "not".mysqli_error($link);
  }
// thông tin ô lưu trữ (storage)
...
<div class="row">
    ...
    <!-- ===================================================================== DROP DOWN BUTTON =========================================================================== -->
                  <div class="shadow">
                    ...
                    <button onclick="show_pro()" class="btn btn-danger btn-lg btn-block" id="DropBtn_pro">Bộ xữ lý</button><!--==== CHANGE HERE =-->
...
<div class="row">
    ...
    <!-- ===================================================================== DROP DOWN BUTTON =========================================================================== -->
                  <div class="shadow">
                    <!--==========================toggle hide myAV-a-dropdown_mb ============================================================-->
                    <button onclick="show_mbd()" class="btn btn-danger btn-lg btn-block" id="DropBtn_mbd">Bo mạnh chủ</button><!--==== CHANGE HERE =-->

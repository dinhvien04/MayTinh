            <?php
                          ...
                          if($logediin==true){
                            ...
                            $sql = "SELECT Propic FROM users WHERE email = ?";
...
<!-- ============================================================================================================ -->
  ...
  <div class="row pt-3 AVuphead" style="background-image: url('assets/upnev.jpg');background-position: center;border-bottom:2px solid red;">
        ...
        <div class="col-md-4">
            <p style="color: white;">VIEN Computers </p>
            <a href="<?php echo $account;?>" id="mcart"><i class="bi bi-cart2" ></i></a>
            <a href="<?php echo $account;?>" id="macc" ><i class="bi bi-people"></i></a>
        </div>

        <div class="col-md-5">
            <form action="search.php" method="GET"> <!-- Thêm action và method -->
              <input type="text" name="query" placeholder="Tìm kiếm"> <!-- Đặt tên cho trường tìm kiếm -->
              <button type="submit">Tìm kiếm</button> <!-- Thêm nút gửi -->
            </form>
        </div>
        ...
        <div class="col-md-3">
            <div class="dropdown show acc">
              ...
              <!-- đăng nhập -->
                ...
                <a class="dropdown-item" href="<?php echo $account; ?>">
                  <i class="bi bi-people" ></i>Đăng nhập</a>
                <?php echo $logout;?>
              </div>
            </div>
          </div>
  ...
  <div class="desktop row sticky-top" >
            <div class="AVnev col-12 bg-dark ">
              ...
              <div class="dropbar"><button class="dropbtn" onclick="window.location.href='index.php';"><h5>Trang chủ</h5></button></div>
        
              <div class="dropbar">
                <button class="dropbtn"><h5>Máy tính</h5></button>
              ...
              <div class="dropbar">
                <button class="dropbtn"><h5>Bộ phận</h5></button>
                <div class="dropdown-content AVparts">
                  <div style="float: left; width:25%;"><a href="accessories.php?accessories=proccessor   "><img src="assets/components/010-cpu-1.png"       >Bộ xữ lý</a><a href="accessories.php?accessories=power     "> <img src="assets/components/021-supply.png"   >Bộ nguồn</a><a href="accessories.php?accessories=opticaldrive"><img src="assets/components/012-mainboard-1.png"    >Ổ đĩa quang</a><a href="accessories.php?accessories=cables    "><img src="assets/components/032-usb-2.png"   > Cables          </a></div>
                  <div style="float: left; width:25%;"><a href="accessories.php?accessories=motherboard  "><img src="assets/components/018-mainboard-3.png" >Bo mạnh chủ</a><a href="accessories.php?accessories=cooling   "> <img src="assets/components/003-fan.png"      >Tản nhiệt</a><a href="accessories.php?accessories=sounds       "><img src="assets/components/027-speaker.png"       >Âm thanh</a><a href="accessories.php?accessories=exstorage "><img src="assets/components/030-usb-1.png"   > Ex-Storage</a></div>
                  <div style="float: left; width:25%;"><a href="accessories.php?accessories=ram          "><img src="assets/components/023-ram.png"         >Bộ nhớ Ram</a><a href="accessories.php?accessories=storage   "> <img src="assets/components/016-hard-disk.png">Bộ lưu trữ dữ liệu</a><a href="accessories.php?accessories=keyboard     "><img src="assets/components/017-keyboard.png"    >Bàn phím</a>                                                                                                                               </div>
                  <div style="float: left; width:25%;"><a href="accessories.php?accessories=graphics     "><img src="assets/components/015-graphic-card.png">Card đồ họa</a><a href="accessories.php?accessories=casing    "> <img src="assets/components/009-server.png"   >Vỏ máy</a><a href="accessories.php?accessories=mice         "><img src="assets/components/036-computer-mouse.png"> Chuột      </a>                                                                                                                               </div>
              ...
              <!-- <div class="dropbar">
                      <button class="dropbtn"><h5>Bộ Phận</h5></button>
                      <div class="dropdown-content AVparts">
                        <div style="float: left; width:25%;"><a href="men.php" ><img src="assets/components/010-cpu-1.png"       > Bộ xử lý   </a><a href="men.php" > <img src="assets/components/021-supply.png"   > Bộ Nguồn </a><a href="men.html"><img src="assets/components/012-mainboard-1.png"   >  Ổ đỉa quang</a><a href="men.html"><img src="assets/components/032-usb-2.png"   > Cáp          </a></div>
                        <div style="float: left; width:25%;"><a href="men.html"><img src="assets/components/018-mainboard-3.png" > Bo mạch chủ </a><a href="men.html"> <img src="assets/components/003-fan.png"      > Tản Nhiệt    </a><a href="men.html"><img src="assets/components/027-speaker.png"       > Âm thanh       </a><a href="men.html"><img src="assets/components/030-usb-1.png"   > Ổ lưu trữ ngoài</a></div>
                        <div style="float: left; width:25%;"><a href="men.html"><img src="assets/components/023-ram.png"         > Bộ nhớ ram       </a><a href="men.html"> <img src="assets/components/016-hard-disk.png"> Bộ Lưu trữ dữ liệu    </a><a href="men.html"><img src="assets/components/017-keyboard.png"      > Bàn Phím     </a>                                                                                      </div>
                        <div style="float: left; width:25%;"><a href="men.html"><img src="assets/components/015-graphic-card.png"> Card đồ họa</a><a href="men.html"> <img src="assets/components/009-server.png"   > Võ máy    </a><a href="men.html"><img src="assets/components/036-computer-mouse.png"> Chuột      </a>                                                                                      </div>
                      </div>
                    </div> -->
        
              <div class="dropbar">
                <button class="dropbtn"><h5>Màn Hình</h5></button>
                <div class="dropdown-content">
              ...
              <div class="dropbar">
                <button class="dropbtn"><h5>Xây dựng PC của bạn</h5></button>
                <div class="dropdown-content">
